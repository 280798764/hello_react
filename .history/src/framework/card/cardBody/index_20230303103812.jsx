...
class CardBody extends React.Component{
    ...
    componentDidMount = () =>{
        const {cardModule, cardType = 'RightList', echarts} = this.props;
        console.log(require(`modules/${cardModule}/${cardType}`),'7777777777777777777777')
        // const InnerComp÷onent = echarts ? GraphCardBody : require(`modules/${cardModule}/${cardType}/index.jsx`).default; // 注意
        const InnerComponent = echarts ? GraphCardBody : require(`modules/${cardModule}/${cardType}`).default; // 注意
        this.setState({
            InnerComponent
        })
    }
    ...
    render(){
        ...
        console.log(InnerComponent, 'InnerComponent=================9999999')
        const {
            filters,
            settings,
            setFilters,
