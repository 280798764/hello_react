...
import x from 'modules/cards/RightList/index.jsx'
console.log(x)
...
class CardBody extends React.Component{
    ...
    componentDidMount = () =>{
        ...
        console.log(cardModule, '==========', cardType, `modules/${cardModule}/${cardType}`)
        const InnerComponent = echarts ? GraphCardBody : require(`modules/${cardModule}/${cardType}/index.jsx`).default; // 注意
